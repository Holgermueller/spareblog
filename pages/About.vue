    ...
    <v-card class="about-card" tile>
      ...
      <v-card-text>
        ...
        <p class="about-paragraph">
          ...
          click-bait articles. I also helped out my parents job, running a
          community care home for psychiatric patients from the VA hospital.
        </p>
        <p class="about-paragraph">
          ...
          rock and jazz. Some would say those to genres are at opposite ends of
          the spectrum, but if you're familiar enough with them I think you find
          they have more in common with each other than any other genre of
          music. I enjoy hiking, which I'm in a pretty good location for, or so
          I'm told. I like weight lifting, and the act of pushing myself to do
          things I didn't know I could do that comes with it. And I love
          ...
          visited so far are Korea, Australia, Italy, and France. Hopefully,
          once I've succeeded in searching through what my options are, I'll
          land a job that helps facilitate my love of travel in some way.
        </p>
        <p class="about-paragraph">
          ...
          blog is to force myaself to write more. But I also realize life gets
          in the way sometimes. If I get something new up here once a month,
          I'll be happy. I hope reading it will make you happy too.
        </p>
        <p class="about-paragraph">Talk to you later.</p>
      </v-card-text>
    </v-card>
  </div>
</template>
